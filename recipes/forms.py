...
class RecipeForm(forms.ModelForm):
    class Meta:
        model=Recipe
        fields=('title', 'featured_image', 'ingridients', 'author', 'content')
        widgets = {
        ...
        labels = {
            ...
            'content': 'Enter directions how to make this recipe and any extra comments information you would like to add: ',
        }
